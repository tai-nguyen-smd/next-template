...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/70 ring-sidebar-ring outline-visible:ring-2 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-all duration-200 ease-linear [&>svg]:size-4 [&>svg]:shrink-0',
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 transition-all outline-none focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
